...
- (void)successPing {
    ...
    [target performSelector:sel withObject:[NSNumber numberWithBool:YES] withObject:simplePing];
...
- (void)failPing:(NSString*)reason {
    ...
    [target performSelector:sel withObject:[NSNumber numberWithBool:NO] withObject:simplePing];
    [self killPing];
}
